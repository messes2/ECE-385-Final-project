...
# Set False Path
#**************************************************************
set_false_path -from [get_ports {KEY* SW* altera_reserved*}]
set_false_path -to [get_ports {LED* altera_reserved*}]
set_false_path -from [get_ports {DRAM_DQ* altera_reserved}]
set_false_path -to [get_ports {DRAM_ADDR* DRAM_BA* DRAM_CAS_N* DRAM_CLK* DRAM_CS_N* DRAM_DQ* DRAM_LDQM* DRAM_RAS_N* DRAM_UDQM* DRAM_WE_N* altera_reserved*}]
